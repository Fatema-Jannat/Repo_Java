...
public class HW1_Q1 {
    public static void main(String[] args) {
        int numOfHours = 24; //Total number of hours in a day
        int numOfDays = 365; //Total number of max no. of days in a years
        int totalNumOfEmpl = 50; //total number of employees in an organisation
        double population = 328.2; //population in a country
        double interestRate = 18.23; //interest rate
        ...
        String sunRise = "No, The sun rises in the east and set in the west."; //Answer to #7 Question
        ...
        System.out.println("4. Population in a country: " + population + " million.");
        System.out.println("5. Interest Rate: " + interestRate +"%");
        System.out.println("6. Balance in a bank account: $"+ accBalance);
        System.out.println("7. Does the sun rise from the west?"+ "\n" + sunRise);// "\n" means new line
